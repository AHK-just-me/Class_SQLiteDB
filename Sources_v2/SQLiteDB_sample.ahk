...
Sleep(1000)
SB_SetText("Version")
WinSetTitle(Title . " - SQLite3.dll v " . DB.Version)
Sleep(1000)
; ======================================================================================================================
...
If !DB.GetTable(SQL, Result)
   MsgBox(16, "SQLite Error", "Msg:`t" . DB.ErrorMsg . "`nCode:`t" . DB.ErrorCode)
ShowTable(Result)
SB_SetText("GetTable: " . SQL . " done (including ListView) in " . (A_TickCount - Start) . " ms")
Return
; ======================================================================================================================
...
RecordSet.Free()
SB_SetText("Query: " . SQL . " done (including ListView) in " . (A_TickCount - Start) . " ms")
Return
; ======================================================================================================================
